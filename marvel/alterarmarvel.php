...
$result_usuario = "UPDATE informacoes SET nome='$nome', ano='$ano', genero='$genero', 
                   classificacao_indicativa='$classificacao_indicativa', duracao='$duracao', diretor='$diretor' 
                   WHERE id = '$id' ";
